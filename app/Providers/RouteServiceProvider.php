...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "newjoin" routes for the application.
     *
     * These routes all receive session state, CSRF protection, etc.
     *
     * @return void
     */
    protected function mapNewjoinRoutes()
    {
        Route::group([
            'middleware' => ['web', 'newjoin', 'auth:newjoin'],
            'prefix' => 'newjoin',
            'as' => 'newjoin.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/newjoin.php');
        });
    }
